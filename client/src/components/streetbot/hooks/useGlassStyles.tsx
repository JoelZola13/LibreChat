...
export function useGlassStyles() {
  ...
  const colors = useMemo(
    () => ({
      ...
      surfaceActive: isDark ? "rgba(255, 255, 255, 0.15)" : "rgba(255, 255, 255, 0.45)",
      ...
      borderActive: isDark ? "rgba(255, 255, 255, 0.35)" : "rgba(255, 255, 255, 0.8)",
      ...
      cardBgHover: isDark ? "rgba(255, 255, 255, 0.10)" : "rgba(255, 255, 255, 0.4)",
