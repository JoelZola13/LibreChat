...
function getMap(): Record<string, PrefetchEntry> {
  ...
  _map = {
    ...
    '/profiles': { chunk: () => import('~/components/streetbot/profile/ProfilePage') },
    '/gallery': { chunk: () => import('~/components/streetbot/gallery/GalleryPage') },
    '/academy': { chunk: () => import('~/components/streetbot/academy/AcademyPage') },
    '/learning': { chunk: () => import('~/components/streetbot/academy/AcademyPage') },
    '/word-on-the-street': { chunk: () => import('~/components/streetbot/forum/ForumPage') },
    ...
    '/myprofile': { chunk: () => import('~/components/streetbot/profile/MyProfilePage') },
