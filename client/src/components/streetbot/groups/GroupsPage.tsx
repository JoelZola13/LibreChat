                  ...
                  >
                    <div
                      style={{
                        ...
                        alignItems: "center",
                        justifyContent: "center",
                        background: group.avatar_url?.startsWith('http')
                          ? 'transparent'
                          : (group.avatar_url || getAvatarColor(group.name)),
                        backgroundImage: group.avatar_url?.startsWith('http')
                    ...
                    >
                      {!group.avatar_url && <Users size={32} color="#fff" />}
                    </div>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        <span style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                          <Users size={14} color={colors.accent} /> {group.member_count.toLocaleString()} members
                        </span>
                        {(group.message_count ?? 0) > 0 && (
                          <span style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                            <MessageCircle size={14} color={colors.accent} /> {group.message_count} messages
                          </span>
                        )}
                      </div>
                      ...
                      {group.last_message && (
                        ...
                        >
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" }}>
                            <span style={{ fontWeight: 600, color: colors.text, display: "flex", alignItems: "center", gap: "4px" }}>
                              {group.last_message.author}
                              {group.last_message.is_agent && (
                                <Bot size={12} color={colors.accent} />
                              )}
                            </span>
                            <span style={{ fontSize: "0.75rem", color: colors.textMuted }}>
                              {timeAgo(group.last_message.timestamp)}
                            </span>
                          </div>
                          <div
                            style={{
