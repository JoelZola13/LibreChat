...
import { filterVisibleAcademyCourses, filterVisibleAcademyPrograms } from './academyLearningPaths';
        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            >
              ...
              <a href={`${basePath}/student-workspace?tab=saved`} style={tabStyle(true)}>
                Saved
              </a>
            </div>
          </div>
        ...
        >
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            ...
            {!loading && savedCourseCards.length === 0 && (
              <div
                className="rounded-[26px] border p-8 text-sm"
