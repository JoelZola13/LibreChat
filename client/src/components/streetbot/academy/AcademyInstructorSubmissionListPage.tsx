          ...
          course.instructor_id !== instructorId ? (
            ...
            >
              ...
              <p
                ...
                style={{ color: colors.textSecondary }}
              >
                This submission list only works for instructors who are currently teaching the
                course.
              </p>
              <a
                href={`${basePath}/courses`}
            ...
            <>
              ...
              >
                <div
                  className="mb-4 hidden grid-cols-[minmax(0,1.2fr)_minmax(0,0.9fr)_minmax(0,0.7fr)_minmax(0,0.8fr)] gap-4 px-3 text-xs font-semibold uppercase tracking-[0.18em] md:grid"
                  style={{ color: colors.textMuted }}
                >
