      ...
      >
        ...
        <div style={{ ...sectionStyle, marginBottom: 32 }}>
          <p style={pStyle}>
            ...
            provided by Street Voices (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;). By
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            ...
            security of your account credentials, including your password, and you are fully
            responsible for all activities that occur under your account. You must immediately
            notify Street Voices of any unauthorized use of your account or any other breach of
            security. Street Voices will not be liable for any loss or damage arising from your
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            You retain ownership of any intellectual property rights that you hold in the content
            you submit, post, or display on or through the Website (&ldquo;User Content&rdquo;). By
          ...
          <p style={pStyle}>
            ...
            reliability, and appropriateness of that content. By posting User Content on the
            Website, you represent and warrant that you have the right and authority to do so and
            that such content does not violate the rights of any third party, including but not
            limited to intellectual property rights, privacy rights, or rights of publicity.
          </p>
          <p style={pStyle}>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            ...
            content, regardless of the cause. You are strongly encouraged to maintain your own
            backup copies of any content or data you submit to the Website. You acknowledge and
            agree that Street Voices shall have no liability for any failure to back up data or for
            any loss of data, whether caused by system failure, human error, or otherwise.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            ...
            recommendation by Street Voices of the linked site or any association with its
            operators. You acknowledge and agree that Street Voices shall not be responsible or
            liable, directly or indirectly, for any damage or loss caused or alleged to be caused by
            or in connection with the use of or reliance on any content, goods, or services
            available on or through any Third-Party Resources.
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            ...
            conduct or content of any third party on the Website; (iii) any content obtained from
            the Website; or (iv) unauthorized access, use, or alteration of your transmissions or
          ...
          <p style={pStyle}>
            ...
            connection with these Terms or the use of the Website exceed the total amount paid by
            you to Street Voices, if any, during the twelve (12) months preceding the date of the
            claim, or one hundred Canadian dollars (CAD $100.00), whichever is less.
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
            Some jurisdictions do not allow the exclusion or limitation of certain warranties or the
            limitation or exclusion of liability for incidental or consequential damages.
            Accordingly, some of the above limitations and disclaimers may not apply to you. To the
            extent that Street Voices may not, as a matter of applicable law, disclaim any warranty
            or limit its liability, the scope and duration of such warranty and the extent of Street
            Voices&apos; liability shall be the minimum permitted under such applicable law.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            ...
            including reasonable attorneys&apos; fees, arising out of or relating to: (i) your use
            of or inability to use the Website; (ii) your violation of these Terms; (iii) your
            violation of any rights of a third party, including intellectual property rights; or
            (iv) any User Content you post on or through the Website.
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
            Street Voices reserves the right, at its own expense, to assume the exclusive defense
            and control of any matter otherwise subject to indemnification by you. In such cases,
            you agree to cooperate with our defense of such claims. This indemnification obligation
            will survive the termination of these Terms and your use of the Website.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            ...
            the courts located in the Province of Ontario, Canada. You hereby irrevocably consent
            and submit to the personal jurisdiction and venue of such courts for the purpose of
            litigating any such action.
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
            Before filing any claim or commencing any legal proceeding, you agree to first attempt
            to resolve the dispute informally by contacting Street Voices at{' '}
            <a
            ...
            dispute is not resolved within thirty (30) days of submission, either party may proceed
            to bring a formal claim in the courts of the Province of Ontario.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            ...
            such changes. If you do not agree to the modified Terms, you must discontinue your use
            of the Website and any related services. It is your responsibility to review these Terms
