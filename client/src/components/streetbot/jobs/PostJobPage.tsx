...
const emptyForm: FormState = {
  ...
  startDate: '',
  expirationDate: '',
  autoCloseOnHire: false,
  tags: '',
  equity_statement: '',
  company_website: '',
  hires_without_address: false,
  hires_with_gaps: false,
  hires_with_record: false,
  provides_work_gear: false,
  same_day_pay: false,
  training_provided: false,
  no_experience_required: false,
  is_transit_accessible: false,
};
...
export default function PostJobPage() {
    ...
    if (isEdit && jobId) {
      ...
      if (listing?.jobData) {
        ...
        setForm({
          ...
          category: j.category || '',
          opportunity_type: j.opportunity_type || 'Full-time',
          work_mode: j.work_mode || 'In Person',
          experience_level: j.experience_level || 'Entry Level',
          location: j.location || '',
          compensation: j.compensation || '',
          salary_range: j.salary_range || '',
          startDate: j.startDate || '',
          expirationDate: j.expirationDate || '',
          autoCloseOnHire: j.autoCloseOnHire || false,
          tags: j.tags || '',
          equity_statement: j.equity_statement || '',
  ...
  const handleSubmit = () => {
    ...
    const id =
      isEdit && jobId ? jobId : `job_${Date.now()}_${Math.random().toString(36).slice(2, 8)}`;
      ...
      <div style={{ position: 'relative', minHeight: '100%' }}>
        ...
        >
          ...
          <div style={sectionStyle}>
            <div
              style={{ display: 'flex', gap: '16px', alignItems: 'center', marginBottom: '20px' }}
            >
              {form.logo_url && (
                <img
                  src={form.logo_url}
  ...
  return (
    <div style={{ position: 'relative', minHeight: '100%' }}>
      ...
      {showDeleteConfirm && (
        ...
        >
          ...
          >
            ...
            <p style={{ color: colors.textSecondary, fontSize: '0.9rem', margin: '0 0 24px' }}>
              This action cannot be undone. All applicant data for this listing will be lost.
            </p>
      ...
      >
        ...
        {errors.length > 0 && (
          ...
          >
            ...
            {errors.map((e, i) => (
              <div
                key={i}
                style={{ fontSize: '0.8rem', color: colors.textSecondary, paddingLeft: '24px' }}
              >
                • {e}
              </div>
            ))}
        ...
        <div style={sectionStyle}>
          <h2 style={{ fontSize: '1rem', fontWeight: 600, color: colors.text, margin: '0 0 20px' }}>
            Job Details
          </h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div>
              ...
              <textarea
                ...
                placeholder="Describe the role, team, and what makes it unique..."
                rows={6}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateField('opportunity_type', e.target.value)}
                style={inputStyle}
              >
        ...
        <div style={sectionStyle}>
          ...
          >
            <input
              type="checkbox"
              checked={form.autoCloseOnHire}
              onChange={(e) => updateField('autoCloseOnHire', e.target.checked)}
          ...
          <div style={{ marginTop: '16px' }}>
            ...
            <input
              ...
              placeholder="e.g. community, nonprofit, youth"
              style={inputStyle}
            />
          </div>
          <div style={{ marginTop: '16px' }}>
            ...
            <textarea
              value={form.equity_statement}
              onChange={(e) => updateField('equity_statement', e.target.value)}
              placeholder="Optional equity and inclusion statement..."
              rows={2}
              style={{ ...inputStyle, resize: 'vertical' }}
            />
          </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 24px' }}>
            ...
            {checkboxRow(
              'Hires Without Address',
              'hires_without_address',
              'Housing not required to apply',
            )}
            ...
            {checkboxRow(
              'Provides Work Gear',
              'provides_work_gear',
              'Necessary equipment/uniforms provided',
            )}
            {checkboxRow('Same Day Pay', 'same_day_pay', 'Get paid the same day you work')}
            {checkboxRow(
              'Transit Accessible',
              'is_transit_accessible',
              'Location is accessible by public transit',
            )}
          </div>
        </div>
