...
import StreetVoicesNav from './StreetVoicesNav';
...
const Nav = memo(
  ({
    ...
    if (isStreetBot) {
      return <StreetVoicesNav navVisible={navVisible} setNavVisible={setNavVisible} />;
    }

    return <DefaultNav navVisible={navVisible} setNavVisible={setNavVisible} />;
  },
);
