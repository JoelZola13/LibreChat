      ...
      <div className="flex h-full flex-col">
        ...
        >
          <div className="flex flex-1 flex-col overflow-hidden" ref={outerContainerRef}>
            ...
            />
            {/* Street Voices shortcuts */}
            <a
              href="http://localhost:9001/admin"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-1 flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-text-primary transition-colors hover:bg-surface-active-alt"
              aria-label="Open Email admin (Listmonk)"
            >
              <svg
              ...
              <span
                ...
                style={{ backgroundColor: '#ffd600', color: '#0a0a0a', letterSpacing: '0.3px' }}
              >
                NEW
              </span>
            </a>
